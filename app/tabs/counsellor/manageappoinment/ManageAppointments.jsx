...
const styles = StyleSheet.create({
  ...
  header: { flexDirection: 'row', alignItems: 'left', justifyContent: 'left', paddingHorizontal: 16, paddingVertical: 16, backgroundColor: '#fff', borderBottomWidth: 1, borderBottomColor: '#F3F4F6' },
  headerTitle: { fontSize: 18, fontWeight: '700', color: TEXT_DARK ,alignItems:'left',justifyContent:'left' },
