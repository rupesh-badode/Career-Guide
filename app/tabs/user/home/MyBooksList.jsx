...
const styles = StyleSheet.create({
  ...
  categoryText: { fontSize: 12, color: '#F59E0B', fontWeight: '700', textTransform: 'uppercase', marginBottom: 4 },
  title: { fontSize: 16, fontWeight: 'bold', color: '#F59E0B', marginBottom: 4 },
  ...
  addToCartBtn: { backgroundColor: '#F59E0B', paddingVertical: 10, borderRadius: 8, alignItems: 'center', justifyContent: 'center' },
