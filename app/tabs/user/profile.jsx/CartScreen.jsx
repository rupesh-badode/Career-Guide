...
const styles = StyleSheet.create({
  ...
  price: { fontSize: 18, fontWeight: 'bold', color: '#F27A21' },
  ...
  checkoutBtn: { backgroundColor: '#F27A21', paddingVertical: 16, borderRadius: 12, alignItems: 'center' },
  ...
  selectedAddressCard: { borderColor: '#F27A21', backgroundColor: '#fff9db', borderWidth: 2 },
  ...
  addAddressText: { color: '#F27A21', fontWeight: 'bold', marginLeft: 8 },
  emptyContainer: { flex: 1, justifyContent: 'center', alignItems: 'center', padding: 20 },
  emptyEmoji: { fontSize: 64, marginBottom: 10 },
  emptyTitle: { fontSize: 20, fontWeight: 'bold' },
  exploreBtn: { backgroundColor: '#F27A21', paddingHorizontal: 24, paddingVertical: 12, borderRadius: 8, marginTop: 10 },
